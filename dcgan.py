...
class Generator(nn.Module):
    def __init__(self, noise, channels_img, f):
        ...
        self.network = nn.Sequential(
            ...
            self.block_gen(noise, f * 16, 4, 1, 0),
            self.block_gen(f * 16, f * 8, 4, 2, 1),  
            self.block_gen(f* 8, f* 4, 4, 2, 1),  
            self.block_gen(f* 4, f* 2, 4, 2, 1),
            nn.ConvTranspose2d(
...
wr = SummaryWriter(f"logs/real")
wf = SummaryWriter(f"logs/fake")
step = 0
